...
public class Assert {
     ...
     *            itself, and which may be used to provide context. It should normally end in a ": "
     *            or ". " so that the function generate message looks ok when prepended to it.
     * @throws IllegalArgumentException if the object is not an instance of clazz
     * @see Class#isInstance
     */
    public static void isInstanceOf(Class<?> type, Object obj, String message) {
        ...
        if (!type.isInstance(obj)) {
            throw new IllegalArgumentException(
                    (StringUtils.isNotEmpty(message) ? message + " " : "") + "Object of class ["
