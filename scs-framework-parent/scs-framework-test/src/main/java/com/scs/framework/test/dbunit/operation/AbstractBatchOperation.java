...
public abstract class AbstractBatchOperation extends AbstractOperation {
    ...
    /**
     * Returns list of tables this operation is applied to. This method allow subclass to do
     * filtering.
     */
    ...
    /**
     * Returns mapping of columns to ignore by this operation. Each bit set represent a column to
     * ignore.
     */
    ...
    /**
     * Returns false if the specified table row have a different ignore mapping than the specified
     * mapping.
     */
    ...
    abstract OperationData getOperationData(ITableMetaData metaData, BitSet ignoreMapping,
                ...
                try {
                    for (int i = start;; i = i + increment) {
                        ...
                        if (ignoreMapping == null
                                || !equalsIgnoreMapping(ignoreMapping, table, row)) {
                        ...
                        for (int j = 0; j < columns.length; j++) {
                            ...
                            if (!ignoreMapping.get(j)) {
                                ...
                                try {
                                    statement.addValue(table.getValue(row, column.getColumnName()),
                                            column.getDataType());
