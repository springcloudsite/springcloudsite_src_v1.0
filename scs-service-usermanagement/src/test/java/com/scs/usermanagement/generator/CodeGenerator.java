 ...
 * All Rights Reserved.
 */
package com.scs.usermanagement.generator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        paramList.add(new GenParam("usermanagement", new String[] { "sys_user", "sys_function", "sys_role", "sys_role_function_relationship", "sys_user_role_relationship" }));
...
//        gc.setDbSchema("scsdi_dev");
        ...
        gc.setDbUrl("jdbc:mysql://10.10.8.53:3306/scsdi?serverTimezone=Asia/Shanghai");
        // 生成PO\VO（自动覆盖）、BaseMapperXML（覆盖）、Dao（不覆盖）、MapperXML（不覆盖）
        // 支持生成的文件类型
        gc.setGenTypes(new GenType[] { GenType.VO, GenType.PO, GenType.DAO, GenType.BASE_MAPPER_XML,
            GenType.MAPPER_XML });
